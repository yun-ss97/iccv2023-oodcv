...
def create_model(num_classes=81, pretrained=True, coco_model=False):
    # Huge
    embed_dim, depth, num_heads, dp =  1280, 32, 16, 0.1
    ...
    if pretrained:
        print('Loading MAE Pretrained ViT Huge weights...')
        ckpt = torch.hub.load_state_dict_from_url('https://dl.fbaipublicfiles.com/mae/pretrain/mae_pretrain_vit_huge.pth')
    ...
    backbone = SimpleFeaturePyramid(
        ...
        out_channels=256,
        scale_factors=(3.5, 1.75, 0.875, 0.4375),
